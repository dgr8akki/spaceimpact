...
public class GameScreen implements Screen {
	...
	public GameScreen(final SpaceImpact2 game) {
          ...
          GlobalVariables.backgroundTexture = new Texture(Gdx.files.internal("background.jpg"));
          backgroundSprite =new Sprite(GlobalVariables.backgroundTexture);
	...
	public void render (float delta) {  
           ...
           game.font.draw(batch, "Scores: " + GlobalVariables.score, GlobalVariables.windowsWidth - 70, GlobalVariables.windowsHeight);
           ...
           if(Gdx.input.isKeyPressed(Input.Keys.SPACE)) spawnBullet();
            if(Gdx.input.isKeyPressed(Input.Keys.D)) {
                shootSound.play();
                game.setScreen(new GameScreenAI(game));
            }
